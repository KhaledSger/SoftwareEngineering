...
public class SecondaryController {
    ...
    void open_1(ActionEvent event) {
        current = 0;
        clinic_info.setText("Name : " + SimpleClient.ClinicList.get(0).getName() + " ,Open : " + SimpleClient.ClinicList.get(0).getOpen() + " ,Close : " + SimpleClient.ClinicList.get(0).getClose());
    }

    @FXML
    void open_2(ActionEvent event) {
        current = 1;
        clinic_info.setText("Name : " + SimpleClient.ClinicList.get(1).getName() + " ,Open : " + SimpleClient.ClinicList.get(1).getOpen() + " ,Close : " + SimpleClient.ClinicList.get(1).getClose());
    }

    @FXML
    void open_3(ActionEvent event) {
        current = 2;
        clinic_info.setText("Name : " + SimpleClient.ClinicList.get(2).getName() + " ,Open : " + SimpleClient.ClinicList.get(2).getOpen() + " ,Close : " + SimpleClient.ClinicList.get(2).getClose());
    }

    @FXML
    void open_4(ActionEvent event) {
        current = 3;
        clinic_info.setText("Name : " + SimpleClient.ClinicList.get(3).getName() + " ,Open : " + SimpleClient.ClinicList.get(3).getOpen() + " ,Close : " + SimpleClient.ClinicList.get(3).getClose());
    }
    ...
    void update_hours(ActionEvent event) {
        ...
        clinic_info.setText("Name : " + SimpleClient.ClinicList.get(current).getName() + " Open : " + SimpleClient.ClinicList.get(current).getOpen() + " Close : " + SimpleClient.ClinicList.get(current).getClose());
